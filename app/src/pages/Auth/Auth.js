...
import { ErrorNotification, SuccesNotification, WarningNotification } from "config/NotificationManager";
...
function Auth() {
  ...
  return (
    <div className="bcgwrap">
      <div className="login-div">
        <div className="logo">
          <br />
          <img src={logo} alt="ImgNotFound" width="10%" />
        </div>
        <div className="title">{translation.AuthTitle[languague]}</div>
        ...
        <form className="form" onSubmit={handleLogin}>
          <div className="username">
            ...
            <input ref={usernameRef} id="username" type="text" placeholder={translation.UsernamePlaceholder[languague]} />
          </div>
          ...
          <div className="password">
            ...
            <input ref={passwordRef} id="password" type="password" placeholder={translation.PasswordPlaceholder[languague]} />
          </div>
